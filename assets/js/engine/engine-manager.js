...
function caps(){return {
  ...
  worker:typeof Worker!=='undefined',offscreen:typeof OffscreenCanvas!=='undefined',audioWorklet:!!(window.AudioContext&&AudioContext.prototype.audioWorklet),
...
N.engine={version:'1.0.2',config,caps,deviceKey,tier,prepareBoot,recommendedBuild,save};
})();
